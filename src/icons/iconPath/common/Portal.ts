...
const portalIconPaths: IconPaths = {
  default:
...
export const getPortalIconPath = (variant: IconVariant = "default"): string => {
  return portalIconPaths[variant] ?? portalIconPaths.default;
};
