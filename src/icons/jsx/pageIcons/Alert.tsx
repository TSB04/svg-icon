...
export const AlertPageIcon = ({ theme = "light" }: { theme: Theme }) => {
  // Example: Change fill color based on theme
  const fillColor = theme === "dark" ? "#0B1719" : "#ec8383";
  const strokeColor = theme === "dark" ? "#0B1719" : "#ec8383";
  return (
    <svg
      version="1.1"
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        <path
          d="M25,25.04V24c0-0.552-0.448-1-1-1h-0.133l-1.288-9.661C22.247,10.855,20.128,9,17.622,9h-3.245
